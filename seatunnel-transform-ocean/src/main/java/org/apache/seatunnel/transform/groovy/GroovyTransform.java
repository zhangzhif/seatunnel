...
public class GroovyTransform extends AbstractCatalogSupportTransform {
    ...
    private GroovyTransformConfig groovyTransformConfig;
    ...
    public GroovyTransform(
            @NonNull GroovyTransformConfig groovyTransformConfig,
            @NonNull CatalogTable catalogTable) {
        super(catalogTable);
        this.groovyTransformConfig = groovyTransformConfig;
    }
    ...
    private void initGroovyTransformer() {
        String groovyRule = getGroovyRule(this.groovyTransformConfig.getCode(), null);
        Class groovyClass;
        try {
